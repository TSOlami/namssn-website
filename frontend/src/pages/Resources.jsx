...
const Resources = () => {
	...
	useEffect(() => {
		axios
			.get("http://127.0.0.1:5000/api/v1/users/resources")
			.then((res) => {
			...
			<div className="relative">
				<div className="flex relative z-2">
					...
					<div
						className={
							isPopUpVisible
								? "blur-[2px] pointer-events-none lg:w-[65%] sm:w-[100%]"
								: "lg:w-[65%] sm:w-[100%] block"
						}
					>
						<HeaderComponent name="Resources" />
						<div className="lg:pt-5 gap:4 w-[100%]">
							<div className="mb-4">
								<span className="px-4 pb-4  font-bold font-crimson text-blue-900 text-xl">
									RESOURCES
								</span>
							</div>
							...
							<div className="px-4 pt-12 flex flex-wrap gap-6  justify-center">
								{fileList.map((file, index) => (
									<ResourceCard
										key={index}
										fileUrl={base_url + file}
										description={
											data[index][file]["description"]
										}
										uploaderUsername={
											data[index][file][
												"uploaderUsername"
						...
						<button
							...
							className="drop-shadow-2xl ring-2 hover:ring-4 fring-4 fixed bottom-4 right-4 md:right-8 lg:right-[30%] xl:right-[30%] z-10 bg-green-600 text-white py-2 px-4 rounded-full"
						>
							<img
								className="lg:w-[30px]"
								src={Upload}
					...
					<div
						className={
							isPopUpVisible
								? "blur-[2px] pointer-events-none w-[35%] sm:hidden md:block hidden lg:block"
								: "w-[35%] sm:hidden md:block hidden lg:block"
						}
					>
						<AnnouncementContainer />
					</div>
		...
		return (
			<div className="flex">
				...
				<div className="text-xl font-crimson w-[100%] fixed left-[43%] font-medium top-[40%]">
					<div className=" w-[100%] fixed left-[43%] font-medium top-[35%]">
				...
				>
					<button
						onClick={handlePopUpOpen}
						className="drop-shadow-2xl ring-2 hover:ring-4 fring-4 fixed left-[45%] top-[45%] z-10 bg-green-600 text-white py-2 px-4 rounded-full"
					>
						<img
							className="lg:w-[30px]"
							src={Upload}
