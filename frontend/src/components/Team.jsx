...
const Team = ({ image, facebook, linkedin, name, position }) => {
	return (
      ...
      {/* empty styling div */}
      <div className="absolute block h-[65px] w-[114px] bg-white top-[127px]">
      </div>

      {/* empty styling div 2 */}

      <div className="absolute block h-[65px] w-[18px] bg-white top-[127px] right-[127px] rounded-xl rounded-br-none z-20">
      </div>

			<div className="bg-black flex flex-row items-center justify-center text-xl gap-4 text-blue-400 absolute w-28 top-[120px] h-14 mt-5 rounded-tl-2xl pr-4">
