...
const Team = ({ image, facebook, twitter, linkedin, name, position }) => {
	return (
		<div className="flex flex-col w-[250px] relative gap-3 m-5 shadow-2xl">
			...
			<div className="bg-black flex flex-row items-center justify-center text-xl gap-4 text-blue-400 absolute w-28 top-[190px] h-14 mt-5 rounded-tl-2xl pl-2 pr-4">
				{facebook && (
